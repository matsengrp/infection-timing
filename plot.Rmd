...
# Make plots!
make_all_plots(data = all_runs_m, x = "ti", y = "eti", compare = FALSE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "ti", y = "apd", compare = FALSE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, y = "apd", x = "vl", compare = FALSE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, y = "mae", x = "vl", compare = FALSE)
```
The following plots show the relationship between Actual Time of Infection, log10(Viral Load), and ADP...

```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
#make_all_plots(data = all_runs_m, x = "none", y = "none", compare = FALSE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "sp_vl", y ="apd_time", compare = FALSE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "ti", y = "apd", compare = TRUE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, y = "apd", x = "vl", compare = TRUE)
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "sp_vl", y ="apd_time", compare = TRUE)
```
