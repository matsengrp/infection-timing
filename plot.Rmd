...
# Make plots!
make_all_plots(data = all_runs_m, x = "ti", y = "eti")
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "ti", y = "apd")
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, y = "apd", x = "vl")
```
...
```{r warning=FALSE, results='hide', message = FALSE}
# Make plots!
make_all_plots(data = all_runs_m, x = "sp_vl", y ="apd_time")
```
