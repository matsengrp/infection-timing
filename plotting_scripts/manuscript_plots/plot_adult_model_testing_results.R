...
together = merge(results, true_results, by= 'ptnum')
setnames(together, 'adult_model_time_since_infection_estimates', 'mean_time_since_infection_estimate')
setnames(together, 'fragment_int', 'fragment')
setnames(together, 'ptnum', 'subject_id')
...
ggsave(paste0('plots/manuscript_figs/adult_model_testing_scatter_by_frag.pdf'), plot = plot_scatter_val, width = 27, height = 9.5, units = 'in', dpi = 750, device = cairo_pdf)
...
ggsave(paste0('plots/manuscript_figs/adult_model_testing_hist_by_frag.pdf'), plot = plot_hist_val, width = 13, height = 11.25, units = 'in', dpi = 750, device = cairo_pdf)
