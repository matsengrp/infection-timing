...
model{
    ...
    observed_time_to_time_since_infection_correction_utero ~ uniform(0,0.75); // subjects infected in utero were most likely infected in the third trimester (of pregnancy)
